...
func Test_TransformToDashedDate(t *testing.T) {
	testCases := map[string]struct {
		...
		"D.M.YYYY":                              {"2.4.1712", "1712-04-02", nil},
		"D.MM.YYYY":                             {"2.04.1712", "1712-04-02", nil},
		"D/MM/YYYY":                             {"2/04/1712", "1712-04-02", nil},
		"YYYY/MM":                               {"1712/04", "1712-04", nil},
		"D/M/YYYY":                              {"2/4/1712", "1712-04-02", nil},
		"YYYY-M-DD":                             {"1712-4-22", "1712-04-22", nil},
		"DD.M.YYYY":                             {"22.4.1712", "1712-04-22", nil},
		"DD.M.YY":                               {"22.4.12", "2012-04-22", nil},
		"DD.MM.YY":                              {"22.04.12", "2012-04-22", nil},
		"MM.YY":                                 {"22.4.12", "2012-04-22", nil},
		"YY with 20th century prefix":           {"69", "1969", nil},
		"YY with 21st century prefix":           {"23", "2023", nil},
		...
		"can handle dashed date with year last 2": {"20-7-1983", "1983-07-20", nil},
		...
		"D Mon YYYY":                              {"3 Jul. 1957", "1957-07-03", nil},
